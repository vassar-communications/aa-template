...
<p>Over 30 years ago, a generous anonymous alumna established the Time Out Grant to fund projects near and dear to the hearts of fellow alums. Through the decades, Vassar graduates have used this opportunity to step out of their comfort zone and create groundbreaking change. The application process is now open until February 15, 2024.</p>

<?php echo cta_link(
    'time-out-grant',
    'Learn more about the Time Out Grant and apply'
); ?>
