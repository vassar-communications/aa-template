...
<?php echo sec_fullBleedImageColumn(
  ...
  <ul class="clean-list-with-borders">
    <li>AAVC Trustee and Ad Hoc Diversity, Equity, and Inclusion Committee Chair</li>
    <li>(she/her/hers)</li>
    <li>Massachusetts</li>
