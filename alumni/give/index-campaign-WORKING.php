...
<?php echo sec_fullBleedImageColumn(
    ...
    '/alumni/assets/img/alumni-give/Convocation_Bell-Ringing-1104-BL-0939.jpg',
    'theme-burgundy quad-pattern has-bg section-large-title image-is-first',
    'mw-100',
    [
      'css' => '--bg-image-opacity: 0.16',
      'img_alt_text' => 'Four students stand on the roof of a building, in front of a large iron wheel.'
    ]
); ?>
