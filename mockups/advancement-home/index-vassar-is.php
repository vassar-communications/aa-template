...
<style>
.vassar-is .section-content {
  max-width: none;
}
.awesome_ticker li:before {
    content: '–';
    margin: 0 1rem;
    color: #fff;
    opacity: 0.4;
...
<?php echo sec_wideContent(
    null,
    null,
    'vassar-is ticker-section theme-burgundy',
    'animation-fade-in animate-when-content-appears animation-group',
    ['css' => '--sequential-animation-item-gap: 0.3s;']
); ?>

    <p class="xanimation-item vassar-is__title mb-5">Vassar is</p>
    <?php echo vassar_is_awesome('xanimation-item'); ?>
