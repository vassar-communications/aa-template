...
$page_info = '{
  ...
  "page_classes":"",
  "feature_image":"/alumni/assets/img/alumni-community/aavc/board/green-anne-aavc-alum-001.jpg"
}';
...
<?php echo sec_fullBleedImageColumn(
    'Anne Green ’93',
    '/alumni/assets/img/alumni-community/aavc/board/green-anne-aavc-alum-001.jpg',
    'image-is-first theme-cream',
    '',
    ['img_alt_text' => 'Anne Green']
); ?>

  <ul class="clean-list-with-borders">
    <li>Nominating and Governance Committee Chair, Communications Advisory Committee Member and Ad Hoc Diversity, Equity and Inclusion Committee</li>
    <li>(she/her/hers)</li>
    <li>New York</li>
