...
<?php
// echo page_partialmasthead($page_info['feature_image']);
?>
...
<?php echo masthead_interiorPage(
  ...
  [
    "img_alt_text" =>
      "Brightly sunlit sidewalk with colorful planted and hanging flowers leading to the entrance of Kautz House on Vassar Campus.",
  ]
); ?>


<?php echo sec_regularContent("Contact Information", "theme-cream", null); ?>
...
<?php include $project_paths["main_project_root"] .
  "/admission/inc/pages/connect/connect-students.php"; ?>
<?php include $project_paths["main_project_root"] .
  "/admission/inc/pages/connect/connect-counselors.php"; ?>
<?php include $project_paths["main_project_root"] .
  "/admission/inc/pages/visit/visit.php"; ?>
