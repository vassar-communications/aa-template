...
<p class="mb-5">Group tours can be scheduled Monday through Friday between 9 a.m. and 5 p.m. ET, based on availability. To schedule, email <a href="">admission@vassar.edu</a>.</p>

<?php echo cta_link(
  'mailto:admission@vassar.edu',
