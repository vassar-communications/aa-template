...
<?php echo sec_fixedCenteredTitle(
   ...
   <b class="slide-from-right nice-big-serif">begins here.</b>',
    ...
    'mw-4',
    ['bg-image-url' => '/examples/college-journey/journey/0100-21-10-kr-fw-general-vassar-0057.jpg',
    ...
    <div class="grid cols-3">
        <?php echo item_cardWithText(
            'Applying to Vassar',
            '',
            ['url' => '/examples/college-journey/apply/untitled-3.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item'
        ); ?>
        ...
        <?php echo item_cardWithText(
            ...
            '',
            ['url' => '/examples/college-journey/apply/untitled-2.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item'
        ); ?>
        ...
        <?php echo item_cardWithText(
            'Request Information',
            '',
            ['url' => '/examples/college-journey/apply/untitled-1.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item'
        ); ?>
...
<p><strong class="cta-link">Learn more</strong></p>
    ...
    'mw-4',
    ['bg-image-url' => '/examples/college-journey/journey/0256-19-10-ja-library-lawn-vassar-vb-038.jpg',
        'bg-image-alt' => 'alt text',
        'css' => '
...
<p><strong class="cta-link">Visiting the Vassar campus</strong></p>
   ',
    ...
    'mw-4',
    ['bg-image-url' => '/examples/college-journey/visit/0216-18-10-jsu-fall-drone-vassar-R01895.jpg',
        'bg-image-alt' => 'alt text',
        'css' => '
      --section-title-size: 14vw;
      --section-title-faded-opacity: 0.1;
...
Vassar is extremely proud of our 1,000-acre campus. There are buildings that showcase classic architecture blended seamlessly with modern, cutting-edge facilities.
    ...
    'mw-4',
    ['bg-image-url' => '/examples/college-journey/visit/0256-19-10-ja-library-lawn-vassar-vb-038.jpg',
        'bg-image-alt' => 'alt text',
        'css' => '
      --section-title-size: 14vw;
      --section-title-faded-opacity: 0.1;
    ...
    <div class="layout-masonry layout-masonry-33 animation-group">
        ...
        <?php echo item_imageCard(
            ...
            null,
            'apple.com',
            ['url' => '/examples/college-journey/fav-places/0056-21-06-kr-campus-vassar-0006.jpg', 'alt' => 'asdfasdfds' ],
        ...
        <?php echo item_imageCard(
            ...
            null,
            'apple.com',
            ['url' => '/examples/college-journey/fav-places/0212-18-10-kr-library-fall-vassar-3819.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item masonry-item text-at-bottom',
            ['hlevel' => 4]
        ); ?>
        ...
        <?php echo item_imageCard(
            ...
            null,
            'apple.com',
            ['url' => '/examples/college-journey/fav-places/0195-19-11-kwe-gordon-vassar-1644.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item masonry-item text-at-bottom',
            ['hlevel' => 4]
        ); ?>
        ...
        <?php echo item_imageCard(
            ...
            null,
            'apple.com',
            ['url' => '/examples/college-journey/fav-places/110619_160over90_Vassar_5483.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item masonry-item text-at-bottom',
            ['hlevel' => 4]
        ); ?>
        ...
        <?php echo item_imageCard(
            ...
            null,
            'apple.com',
            ['url' => '/examples/college-journey/fav-places/farm-ramble-walking-Tour-1709-sal-1.jpg', 'alt' => 'asdfasdfds' ],
        ...
        <?php echo item_imageCard(
            ...
            null,
            'apple.com',
            ['url' => '/examples/college-journey/fav-places/studio.jpg', 'alt' => 'asdfasdfds' ],
            'animation-item masonry-item text-at-bottom',
            ['hlevel' => 4]
        ); ?>
