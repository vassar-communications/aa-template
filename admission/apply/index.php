...
<?php echo sec_hasColumns(
    ...
    3,
    '<p>Follow the links below or <a href="mailto:admission@vassar.edu">contact Admission</a>, reach out to your Admission Officer, or <a href="mailto:askastudent@vassar.edu">ask a current Vassar student</a>!</p>',
